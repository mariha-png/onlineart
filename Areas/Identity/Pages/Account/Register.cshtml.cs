    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.UserName = Input.Email; // ✅ REQUIRED LINE
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, Role.Role_User); // default
                    }
                    else
                    {
                    ...
                    return RedirectToPage("Login"); // or RedirectToPage("RegisterConfirmation")
                }
